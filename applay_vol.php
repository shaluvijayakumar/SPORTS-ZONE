...
<body class="main">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card" style="margin-top:40px;">
                    <div class="cantainer">
                        <h3 align="center" style="color: red;"> Volunteer Applay FORM</h3>
    ...
    if (isset($_POST["sub"])) {
        ...
        if ($con) {
            $q = "insert into volunteer_details(name,rno,gender,date,department,class,game,status)values('$nam','$rolno','$gender','$dat','$dp','$cls','$game','$sta')";
