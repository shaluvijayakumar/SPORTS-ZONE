...
<div class="main">
    <div class="row">
        <div class="col-md-12">
            ...
            $con = mysqli_connect("localhost", "root", "", "sports");
            if ($con) {
                $q = "select * from volunteer_details where status='new'and department='$dep' and class='$class'";
                $sql = mysqli_query($con, $q);
            ...
            if (isset($_POST["app"])) {
                ...
                $con = mysqli_connect("localhost", "root", "", "sports");
                if ($con) {
                    $q = "update volunteer_details set status='faculty approve' where id='$ID'";
                    $sql = mysqli_query($con, $q);
                }
            }
            ...
            if (isset($_POST["reg"])) {
                ...
                $con = mysqli_connect("localhost", "root", "", "sports");
                if ($con) {
                    $qi = "update volunteer_details set status='Reject by faculty' where id='$ID'";
